...
@section('title','Listar funcionário')
...
<div id=conteudo>
    ...
    <tbody>
        ...
        <tr>
            ...
            <th>{{ $funcionario->cidade }}</th>
            <th>{{ $funcionario->telefone }}</th>
            <th>{{ $funcionario->datanasc }}</th>
            <th>{{ $funcionario->cpf }}</th>
            <th>{{ $funcionario->cargo }}</th>
            <th>{{ $funcionario->salario }}</th>
            <th class="d-flex">
                <a href="{{ route('funcionarios-edit', ['id'=>$funcionario->id]) }}" class="btn btn-primary me-2">Alterar
